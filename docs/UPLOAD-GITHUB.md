# Upload PEPK Workspace v0.5.0 ke GitHub

1. Ekstrak `pepk-workspace-v0.5.0.zip`.
2. Buka repository `pepk-workspace`.
3. Pilih **Add file → Upload files**.
4. Upload seluruh isi folder `pepk-workspace-v0.5.0` ke root repository.
5. Timpa file versi sebelumnya.
6. Commit dengan pesan: `fix(data): hubungkan spreadsheet baru pada v0.5.0`.
7. Tunggu GitHub Pages selesai memperbarui situs.
8. Buka situs menggunakan `Ctrl + F5`.

## Pemeriksaan

- Footer menampilkan versi `0.5.0`.
